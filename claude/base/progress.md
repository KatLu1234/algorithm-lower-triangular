...
| `drafts/algorithm-tree.md` | 알고리즘 분해 트리 — 시간표 도메인 §9 확정 (locked). 건물 슬롯 단위(TimeSlot.building) 수정 반영. A-1 blackout 슬롯 단위 제거(any)·A-2 최소 쉬는시간(min_break) 반영. §1~§8 LT-as-DAG 자료는 폐기 대기 | 2026-05-25 |
